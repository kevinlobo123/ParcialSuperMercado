...
function eliminarUsuario(id){
    ...
    .then(function(data){
        listUsuario()
        alertas("Se ha eliminado el usuario con exito!", 2)
    })
}
...
async function modificarUsuario(id){
    ...
    listUsuario();
    alertas("Se ha modificado el usuario con exito!", 1)
...
function listUsuario(){
    ...
    .then(function(data){
        ...
        '</tr>';
         ...
         document.getElementById("listUsuario").innerHTML=usuarios;
...
function verProducto(id){
    ...
    .then(function(producto){
        ...
        if(producto){
            ...
            '<li class="list-group-item">Tipo de Producto: '+producto.descripProducto+'</li>'+
            '<li class="list-group-item">Fecha de vencimiento: '+producto.fechavencProducto+'</li>'+
            '</ul>'+
            '<br>'
         }
         document.getElementById("contentModal").innerHTML=cadena;
